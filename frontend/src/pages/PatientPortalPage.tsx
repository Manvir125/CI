...
export default function PatientPortalPage() {
    ...
    if (step === 'loading') return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
            <div className="text-center">
                <div className="w-12 h-12 border-4 border-esmerald-700 border-t-transparent
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Cabecera del portal */}
            <header className="bg-esmerald-700 text-white px-4 py-4 sticky top-0 z-10">
                <div className="max-w-2xl mx-auto">
                    <p className="text-esmerald-300 text-xs">
                        Consorci Hospitalari Provincial de Castelló
                    </p>
                ...
                {step === 'verify' && consent && (
                    <div className="bg-white rounded-2xl shadow-sm p-6 mt-4">
                        ...
                        <div className="text-center mb-6">
                            <div className="w-14 h-14 bg-esmerald-100 rounded-full flex items-center
                     ...
                     focus:outline-none focus:border-blue-500 transition-colors"
                        ...
                        px-4 py-3 rounded-xl text-sm text-center">
                            ...
                            <button
                                ...
                                className="w-full bg-esmerald-700 text-white py-4 rounded-xl
                   font-semibold text-base hover:bg-esmerald-800
                            ...
                            <div className="text-center pt-2">
                                ...
                                {resendCooldown > 0 ? (
                                    ...
                                    <button
                                        ...
                                        disabled={resending}
                                        className="text-esmerald-600 hover:text-esmerald-800 text-sm
                ...
                {step === 'read' && consent && (
                    <div className="mt-4 space-y-4">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                            <div className="bg-esmerald-50 px-5 py-3 border-b border-esmerald-100">
                                <p className="text-esmerald-800 text-sm font-medium">
                            ...
                            <div className="bg-gray-50 px-4 py-2 border-b border-gray-200
                              flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    className="text-sm text-esmerald-600 hover:text-esmerald-800"
                                >
                                    Borrar
                                </button>
                            </div>
